                    ...
                    <td>
                        <a href="admin_home_page.php?page=nilai&tingkat=<?php echo $a_tingkat?>&detail=<?php echo $row["NIM"]?>">
                            <button class="button-edit" id="buttonEdit">
                                <i class="fa fa-info" aria-hidden="ture"></i>Detail
                            </button>
                        </a>
                    </td>
                </tr>
...
?>
                    ...
                    <td>
                        ...
                        "<?php echo $a_tingkat?>")'>
                            <button class="button-delete">
                                <i class="fa fa-trash" aria-hidden="ture"></i>Delete
                            </button>
                        </a>
                    </td>
                </tr>
    ...
    <div id="myModal0" class="modal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form name="input" method="post" action="nilai/nilai_input.php">
                    <input type="hidden" name="tingkat" value="<?php echo $a_tingkat ?>">
                    <label for="fnim">NIM</label>
                    <input type="text" id="fnim" name="nim" value="<?php echo $a_nim ?>" readonly>
                    <label for="fmatkul">Matkul</label>
                    <input type="text" id="fmatkul" list="matkul" placeholder="Mata Kuliah">
                    <datalist id="matkul">
                        <?php
