                ...
                <div>
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h2>Update Data Mahasiswa</h2><hr>
                        </div>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form name="input" method="post" action="mahasiswa/mahasiswa_input.php">
                ...
                <label for="ftingkat">Tingkat</label>
                <input type="number" id="ftingkat" name="tingkat" placeholder="Tingkat" min=1 required>
                    <datalist id="tingkat">
                ...
                <input type="password" id="fpass" pattern="[a-zA-Z0-9]+" title="Masukan Hanya Alphanumeric" required>
                <input type="submit">
            </form>
        </div>
    </div>
